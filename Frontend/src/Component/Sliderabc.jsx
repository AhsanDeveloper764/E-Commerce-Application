...
import data from "./slide1";
import data1 from "./slide2data";
import data2 from "./slide3";

const Sliderabc = (props) => {
  const [getslide, setslide] = useState(data);
  const [slidedata, setslidedata] = useState(data1);
  const [slideA, setslideA] = useState(data2);
  // console.log("sdsd",getslide)
  return (
          ...
          return (
            <SwiperSlide key={index}>
              <div className="slide-item">
                <img src={item.img} className={item.clName} alt="" />
              </div>
            </SwiperSlide>
          );
        })}
